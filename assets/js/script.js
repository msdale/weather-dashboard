...
var setHistory = function () {
  ...
  if (!foundCityWeatherData(cityName)) {
    cityWeatherData.push({ "city": cityName, "currentDay": currentDay, "next5Days": next5Days });
    setHistoryBtn(cityName);
  }
};

var setHistoryBtn = function (city) {
  var historyBtnsEl = document.querySelector("#history-buttons");
  ...
  historyBtnsEl.appendChild(listItemEl);
}
